...
```routeros
/system scheduler
add comment="cron: update abuseipdb-s100-1d everyday" interval=1d name=abuseipdb-s100-1d on-event=":execute dhcp2dns_update" policy=read,write,policy,test start-date=2025-05-21 start-time=06:00:00
```
